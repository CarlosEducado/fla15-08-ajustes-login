...
<body>
    ...
    <div class="img-inicio">
        <h4 class="titulo-login">Entre No Clube Do Rubro-Negro</h4>
        <img src="https://images.mengo.com.br/matchday/prod/assets/img/HomeEstadio2024/bg-experience.png"  alt="">
    </div>
    <?php
